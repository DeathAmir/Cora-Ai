...
return [
    ...
    'ai' => [
        ...
        'image_url' => 'https://router.huggingface.co/together/v1/images/generations',
        ...
        'text_models' => [
            ['id'=>'Qwen/Qwen2.5-7B-Instruct-1M:cheapest','name'=>'Qwen 2.5','author'=>'Qwen','avatar'=>'https://huggingface.co/Qwen.png','description'=>'سریع و متعادل برای گفتگوی روزمره','badge'=>'پیشنهادی'],
            ['id'=>'openai/gpt-oss-20b:cheapest','name'=>'GPT-OSS 20B','author'=>'OpenAI','avatar'=>'https://huggingface.co/openai.png','description'=>'استدلال و پاسخ‌های دقیق‌تر','badge'=>'Reasoning'],
            ['id'=>'Qwen/Qwen2.5-Coder-32B-Instruct:cheapest','name'=>'Qwen Coder','author'=>'Qwen','avatar'=>'https://huggingface.co/Qwen.png','description'=>'بهینه‌شده برای برنامه‌نویسی و دیباگ','badge'=>'Code'],
            ['id'=>'meta-llama/Llama-3.2-3B-Instruct:cheapest','name'=>'Llama 3.2','author'=>'Meta','avatar'=>'https://huggingface.co/meta-llama.png','description'=>'سبک و سریع برای پاسخ‌های کوتاه','badge'=>'Fast'],
        ],
        'image_models' => [
            ['id'=>'black-forest-labs/FLUX.1-schnell','name'=>'Cora Image','author'=>'Black Forest Labs','avatar'=>'https://huggingface.co/black-forest-labs.png','description'=>'تولید تصویر سریع و باکیفیت','badge'=>'FLUX','steps'=>4],
        ],
    ],
];
